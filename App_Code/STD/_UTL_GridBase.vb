    ...
    Private Sub gvInit()
      Try
        If Session("PageSizeProvider") = True Then
          SIS.SYS.Utilities.GlobalVariables.PageSize(FileName, HttpContext.Current.Session("LoginID"), _PageSize)
        Else
          Session("PageSize_" & FileName) = _PageSize
        End If
        _GridView1.PageSize = _PageSize
        If Session("PageNoProvider") = True Then
